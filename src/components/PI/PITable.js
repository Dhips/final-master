...
const INITIAL_STATE = {
  AA: '1.0', AB: '1', AC: '1', AD: '1', AE: '1', AF: '1', AG: '1', AH: '1', AI: '1', AJ: '1',
  BA: '', BB: '1.0', BC: '1', BD: '1', BE: '1', BF: '1', BG: '1', BH: '1', BI: '1', BJ: '1', 
  CA: '', CB: '', CC: '1.0', CD: '1', CE: '1', CF: '1', CG: '1', CH: '1', CI: '1', CJ: '1',
  DA: '', DB: '', DC: '', DD: '1.0', DE: '1', DF: '1', DG: '1', DH: '1', DI: '1', DJ: '1',
  EA: '', EB: '', EC: '', ED: '', EE: '1.0', EF: '1', EG: '1', EH: '1', EI: '1', EJ: '1',
  FA: '', FB: '', FC: '', FD: '', FE: '', FF: '1.0', FG: '1', FH: '1', FI: '1', FJ: '1',
  GA: '', GB: '', GC: '', GD: '', GE: '', GF: '', GG: '1.0', GH: '1', GI: '1', GJ: '1',
  HA: '', HB: '', HC: '', HD: '', HE: '', HF: '', HG: '', HH: '1.0', HI: '1', HJ: '1',
  IA: '', IB: '', IC: '', ID: '', IE: '', IF: '', IG: '', IH: '', II: '1.0', IJ: '1',
          ...
          <ProductTable
            products={[
              { id: 1, criteria: '1. Finance', indicators:'(A) Profit Margin' ,
                finance1: <TextField value={AA} type="number" maxLength={3} margin="normal"/>,
              ...
              { id: 2, criteria: '2. Finance', indicators:'(B) Sales Volume Projection' , 
                ...
                finance2: <TextField value={BB} type="number" maxLength={3} margin="normal"/>,
              ...
              { id: 3, criteria: '3. Timeline', indicators:'(C) Overdue Tasks (%)',
                ...
                timeline1: <TextField value={CC} type="number" maxLength={3} margin="normal"/>,
              ...
              { id: 4, criteria: '4. Product Performance', indicators:'(D) Failure Rate',
                ...
                product1: <TextField value={DD} type="number" maxLength={3} margin="normal"/>,
              ...
              { id: 5, criteria: '5. Product Performance', indicators:'(E) Customer Complaints',
                ...
                product2: <TextField value={EE} type="number" maxLength={3} margin="normal"/>,
              ...
              { id: 6, criteria: '6. Brand Performance', indicators:'(F) Market Share' ,
                ...
                brand1: <TextField value={FF} type="number" maxLength={3} margin="normal"/>,
              ...
              { id: 7, criteria: '7. Brand Performance', indicators:'(G) Market Growth Projection' ,
                ...
                brand2: <TextField value={GG} type="number" maxLength={3} margin="normal"/>,
              ...
              { id: 8, criteria: '8. Human Resource', indicators:'(H) Capacity Allocation' ,
                ...
                human1: <TextField value={HH} type="number" maxLength={3} margin="normal"/>,
              ...
              { id: 9, criteria: '9. Production', indicators:'(I) Energy Consumption',
                ...
                production1: <TextField value={II} type="number" maxLength={3} margin="normal"/>,
              ...
              { id: 10, criteria: '10. Production', indicators:'(J) Rework Percentage',
                ...
                production2: <TextField value={JJ} type="number" maxLength={3} margin="normal"/>,
